# Deterministic evaluation of models/ik_warmstart_model.zip
# Same pattern as evaluate_phase2_from_orientation_first.py, pointed at the
# IK warm-start result for direct comparison against the other methods.
...
N_EPISODES = 100
MODEL_PATH = "models/ik_warmstart_model"
...
print("\n========== IK WARM-START EVALUATION SUMMARY ==========")
